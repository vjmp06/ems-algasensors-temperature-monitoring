...
public class RabbitMQConfig {
    ...
    private static final String PROCESS_TEMPERATURE = "temperature-monitoring.processing-temperature.v1";
    ...
    public static final String QUEUE_ALERTING = "temperature-monitoring.processing-alerting.v1.q";
    ...
    public Binding bindingProcessingTemperature() {
        return  BindingBuilder.bind(queueProcessingTemperature()).to(exchange());
    }
